...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1.setText(oneTable.onescenario_ru[61]);
        button_1.setText(oneTable.onescenario_ru[62]);
        button_2.setText(oneTable.onescenario_ru[63]);
        ...
        button_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent (Level8.this, Level6.class);
                    startActivity(intent);finish();
                } catch (Exception e) {
