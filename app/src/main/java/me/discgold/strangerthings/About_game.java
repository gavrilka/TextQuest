...
public class About_game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_about2.setText(oneTable.onescenario_ru[16]);
        textView_about3.setText(oneTable.onescenario_ru[15]);
        ...
        button_back_to_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent (About_game.this, MainActivity.class);
    ...
    class Delay extends AsyncTask<Void, Integer, Void>{
        ...
        final Animation a = AnimationUtils.loadAnimation(About_game.this, R.anim.alpha);
